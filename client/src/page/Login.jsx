...
export default function Login() {
    ...
    /* 네이버 API연동 로그인 */
    const NaverLogin = () => {
        const naver_client_id = "Aot8PsS2gfh4PzSET5k5";
        const callbackUrl = "http://localhost:3000/signup/redirect"; // 네이버 개발자 센터에 등록한 URL
    ...
    const kakaoLogin = () =>{
        ...
        const redirect_uri = 'http://localhost:3000/signup/redirect';
